...
$sql1="UPDATE purchase_order SET payment_id='$mode_of_pay_serz',payment_status='1' WHERE id='$po_id'";
...
$inventory_sql="SELECT * FROM purchase_order_details WHERE po_id='$po_id'";
...
while($inventory_row=mysqli_fetch_array($inventory_query)){
  ...
  $sql2="UPDATE purchase_order_details SET entry_status='2' WHERE id='$inventory_id'";
...
$sql="INSERT INTO purchase_details(`po_id`, `item_id`,`qty`, `unit_id`,`rate`,`discount`, `tax`, `price`, `entry_status`,`date_of_entry`,`store_id`) VALUES ('$po_id','$item_id','$qty','$unit_id','$rate','$disc','$tax','$total','2','$now','$store_id')";
