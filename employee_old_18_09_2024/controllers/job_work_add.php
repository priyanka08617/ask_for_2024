...
$sql="INSERT INTO  job_work (cat_id,sub_cat_id, item_type, item, uom_id, part_no, hsn_table_id, hsn_rate_id,table_name,status, row_created_on)VALUES('1','1','1','$item_x', '$uom_id_x', '$part_no_x', '$hsn_table_id_x', '$hsn_rate_id_x','1','1','$co')";
