...
$sql="INSERT INTO  product ( category_id, subcategory_id, price,  name, qty, uom_id, table_name, hsn_table_id,alias, hsn_rate_id ,status, row_created_on)VALUES('$category_id_x', '$subcategory_id_x', '$price_x', '$name_x', '$qty_x', '$uom_id_x', '2', '$hsn_table_id_x', '$alias', '$hsn_rate_id_x', '$status_x','$co')";
