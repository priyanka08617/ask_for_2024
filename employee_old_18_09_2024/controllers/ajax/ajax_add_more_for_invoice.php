...
$data.='<td><input class="form-control" type="text" name="mtm" id="mtm_'.$c.'" placeholder="Enter Qty"   onkeyup="get_qty_rate('.$c.')" step="0.01"></td>';
...
$data.='<td><input type="text" class="form-control" name="discount_per_item" id=discount_per_item_'.$c.'"></td>';

$data.='<td><input type="text" class="form-control" name="gst" id=gst_'.$c.'" readonly></td>';
