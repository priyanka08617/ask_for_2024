...
$sale_or_service=sanitize_input($conn,$_POST["sale_or_service"]);
...
if($source_id=="walking"){
    ...
    $sql="SELECT * FROM `branch` WHERE `status`='1' AND `id`='$store_id'";
...
$data="<input type='text' class='form-control' name='source_data_id' id='source_data_id' placeholder='Lead From' value='Lenovo'>";
}
