...
<body>
    <div class='container-fluid' style=''>
        <!-- Form Name -->
        <h3> Items Available In Location </h3><small class='text-muted'>Start typing the location details, the stock will be shown accordingly.</small>
...
<div id="summary"></div>
   ...
   function fetch_location_item_details(location_id){
          ...
          $.ajax({
            ...
            url:"../controllers/ajax/ajax_find_location_stock_details.php",
