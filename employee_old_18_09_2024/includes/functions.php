...
function singleRowArryFromTable($conn, $sql){
...
function check_item_or_product_data($conn,$item_id,$item_type){
  ...
  if($item_type==1 ||  $item_type=='i'){
    ...
    $data = array('category' => $category["category_name"],'name' => $row["item"],'uom_id' => $row["uom_id"], 'uom_name' => $uom_details_array["uom_name"],'hsn_code' => $hsn_table["code"],'hsn_rate_id' => $hsn_rate_id);
    ...
    $data = array('category' => $category["category"],'name' => $row["name"],'uom_id' => $row["uom_id"], 'uom_name' => $uom_details_array["uom_name"],'hsn_code' => $hsn_table["code"],'hsn_rate_id' => $hsn_rate_id);
