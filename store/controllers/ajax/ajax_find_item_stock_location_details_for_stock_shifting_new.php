<?php 
 ...
 $uom_relation_data=uom_relation_data($conn,$uom_id);
...
echo ' <td class="grText" >'.$data['total']." ".$uom_name.'</td>';
        ...
        echo'
        <input type="number" class="form-control" name="stock_quantity[]" id="stock_quantity'.$c.'" value="0" min="0" max="'.$data['total'].'" step="0.01" />
        
          <div class="input-group-append">
            <div class="input-group-text">
            <select name="uom_id_relation" id="uom_id_relation[]" onchange="check_uom_for_max_qty(this.value,'.$c.','.$location_id.','.$item_id.','.$item_type.')">
