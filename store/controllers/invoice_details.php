...
// include '../includes/navbar.php';
     ?>
      <br>
        ...
        <?php echo '<a href="receipts.php" ><img src="../img/back.png" height="20px" ></a> ';?>
...
if($position_status_id==1){
  $position_status_check_fullfiled="<button type='submit' class='btn btn-warning btn-block' id='unfullfilled' onclick='fullfill();'>Unfulfilled</button>";
  ...
  if($payment_type_id==1){
    ...
    $position_status="<button type='button' class='btn btn-danger btn-block' onclick='payment(".$order_id.",".$unpaid_amount.")'>Unpaid</button>";
   $unpaid_amount= $total_amount;
      ...
      $unpaid_amount_tot= $total_amount-$unpaid_amount;
        $position_status="<button type='button' class='btn btn-warning btn-block' onclick='payment(".$order_id.",".$unpaid_amount_tot.")'>Unpaid ".$total_amount-$unpaid_amount."</button>";
...
<?php 
include '../includes/sidebar_tail.php';
// include '../includes/navbar.php';
     ?>