...
<head>
    <title>Mutate Assembled Product</title>
    <?php 
...
<h3> Assembled Product Mutate From <b> <?php echo $name_p; ?></b></h3><small class='text-muted'>Fill in the given below tab to mutate assemble product.</small>
        <hr>
<br>
    <form class='form-horizontal' action='../controllers/product_mutate.php' method='post'>
    ...
    <div class='form-group row'>
                        ...
                        <div class='col-md-10'>
                            ...
                            <select class='form-control' name='status' id='status'>
                                ...
                                <option value='2'>For Tender </option>       
                                <option value='1'>Assembled Purchase</option>  
                                </select>
                        </div>
                    </div>
    ...
    <!-- //  content  1 -->
        ...
        <div class='form-group row'>
            ...
            <?php echo " <input type='number' min='0' step='0.01' class='form-control' value=".$price_p." placeholder='Enter price (Optional)' name='price' id='price'>";?>
        ...
        <div class='form-group row'>
            ...
            <div class='col-md-10'>
                ...
                <?php echo "  <input type='text' onkeyup='check_duplicate();' class='form-control' placeholder='Enter name' value='' name='name' required id='name'>";?>
...
<div class="input-group-append">
    <span class="input-group-text" id="username_check_response"></span>
        ...
        <div class='form-group row'>
            ...
            <div class='col-md-10'>
            <?php echo " <input type='number' min='1' class='form-control' placeholder='Enter qty' value=".$qty_p." required name='qty' id='qty'>";?>
        ...
        <div class='form-group row'>
            ...
            <div class='col-md-10'>
                ...
                <select class='form-control' required name='uom_id_new' id='uom_id'>
                    <option value=''>select</option>
                    <?php
...
UNION 
SELECT j.id,  concat(j.id,'3') , j.item FROM job_work j ";
