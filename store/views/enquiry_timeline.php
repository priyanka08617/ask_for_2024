...
$sql1_poa_creation="INSERT INTO `enquiry_management_timeline`(`enquiry_management_id`,`poa`,`date`, `time`, `remarks1`, `row_created_on`,`poa_action_status`, `status`,`start_call`,`end_call`,`remarks2`) VALUES ('$enquiry_id','$poa_x','$poa_date_x','$poa_time_x','$poa_remarks_x','$co','1','1','$start_call','$end_Call','$remark2')";
mysqli_query($conn,$sql1_poa_creation);
echo mysqli_error($conn);

// echo $sql1_poa_creation;
