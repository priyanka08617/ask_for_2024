...
<!-- Form Name -->
<h3> Service </h3><p class='text-muted'>Fill in the given below tab to create Service</p><hr></hr>
<!-- my code start  --> 
<ul class='nav nav-tabs nav-justified'>
<li   class="nav-item">
            <a class='nav-link' data-toggle='tab' href='#home'>Service Creation</a></li>
<li class="nav-item ">
            <a class='nav-link active'  data-toggle='tab' href='#menu1'>Existing Service</a></li>
            </ul>
...
<div class='col-md-2'><label class='control-label' for='uom'>Locations Category</label></div>
<div class='col-md-6'>
