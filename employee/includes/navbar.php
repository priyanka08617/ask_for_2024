...
<nav class="navbar navbar-expand-md  navbar-light sticky-top" style="background-color:#EDEDED">
    ...
    <a class="navbar-brand" href="#"><img style="margin-top: -6px" id="logo" src="..\img\logo_old.svg" width="150"
            class="img" alt="a"></a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="enquiry_managment.php">Enquiry Managment</a>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown text-right ">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" data-toggle="dropdown"
                    ...
                    <b><?php echo  $name; ?> </b><img style="margin-top: -6px" id="profile"
                        src="..\img\icon\profile.png" width="30px" class="img" alt="profile">
                </a>
