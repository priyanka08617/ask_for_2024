...
while($row1=mysqli_fetch_array($query)){
    ...
    if($row1["end_call"]=="00:00:00"){
      ...
      if($row1["action_take_date"]=="00:00:00"){
       $action_take_date="--";
    }else{
       $action_take_date=date($row1["action_take_date"]);
    }
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <!-- <div class='form-group row'>
                                ...
                                <div class='col-md-6' id='end_time'></div>
                            </div>
 -->
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="enqiry_id_for_poa_creation"
...
mysqli_query($conn,"UPDATE `enquiry_management_timeline` SET `remarks2`='$remarks2',`end_call`='$end_time',`action_taken_date`='$action_taken_date',`poa_action_status`='2' WHERE `id`='$enquiry_management_timeline_id'");
...
$sql1="INSERT INTO `enquiry_management_timeline`(`enquiry_management_id`,`poa`,`date`, `time`, `remarks1`, `row_created_on`,`poa_action_status`, `status`) VALUES ('$enquiry_id','$poa_x','$poa_date_x','$poa_time_x','$poa_remarks_x','$co','1','1')";
...
if(start_time=="00:00:00"){
    ...
    $(document). ready(function(){ 
        $('#submit_poa_action').attr("disabled", true);
        $('#poa_time').datetimepicker({ timeFormat: 'h:mm p'});
    });
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                if(res[0]==1){
                    ...
                    // $("#submit_button").empty();
                    // $("#submit_button").append('<button type="submit" class="btn btn-primary btn-block" name="submit_poa_action" enabled>submit</button>');
