...
$sql="INSERT INTO `specification_subhead`(`specification_head_id`,`subhead_name`,`status`) VALUES ('$specification_head_id_onpage_submit','$specification_subhead_onpage_submit','1')";
                        ...
                        <center>
                            <form method="post" action="">
                                ...
                                <div class="row" style="margin-left:430px">
                                    <div class="input-group mb-2 d-grid" style="width:600px">
