...
<br><br>
                        ...
                        <div class="col-md-2"><h5><b><span>Sub : </b></span> </h5> </div>
                            <div class="col-md-10"><input type="text" class="form-control" id="subject" name="subject" value="<?php echo $subject;?>" style="width:90%"></div>
                        </div> </center><br>
...
?>
 ...
 <?php
      ...
      if($item_description_data["item"]==$item_id_concated){
         ...
         echo "<tr id='item_".$item_id_concated."_".$c."'>";
         echo "<th><center>".$item_description_data["item_head_".$item_id_concated]."</center></th>";
         echo "<td><input type='text' class='form-control' name='' id='' value='".$item_description_data["item_subhead_".$item_id_concated]."'></td>";
         echo "<td><img src='../img/cancel.png' width='30px' width='30px' onclick='remove_item_subsection(".$c.",".$item_id_concated.")'></td>";
         echo "</tr>";
