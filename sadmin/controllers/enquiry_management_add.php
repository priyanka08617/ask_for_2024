...
$sql3="INSERT INTO  `enquiry_management` ( `enquiry_date`,`source_type`,`source`, `customer_name`,`customer_mobile`,`customer_mail`, `enquiry`,`created_by`,`enquiry_status`,`store_id`,`user_category_id`,`row_created_on`,`status`)VALUES('$enquiry_date_x','$source_type_x','$source_data_id_x', '$customer_name_x','$customer_mobile_x','$customer_mail_x','$enquiry_x','$created_by_x','$enquiry_status_x', '$store_id','$user_category_id_x','$co','1')";
...
// $sql3="INSERT INTO  `enquiry_management` ( `enquiry_date`,`source_type`,`source`, `customer_name`,`customer_mobile`,`customer_mail`, `enquiry`,`created_by`,`enquiry_status`,`store_id`,`user_category_id`,`row_created_on`,`status`,`enquiry_status`)VALUES('$enquiry_date_x','$source_type_x','$source_data_id_x', '$customer_name_x','$customer_mobile_x','$customer_mail_x','$enquiry_x','$created_by_x','$enquiry_status_x', '$store_id','$user_category_id_x','$co','1','$enquiry_status_x')";
