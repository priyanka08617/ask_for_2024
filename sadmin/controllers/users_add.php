...
$branch_id_x=sanitize_input($conn,$_POST['branch_id']);
...
$sql="INSERT INTO  `users` ( `module_id`, `user_category_id`, `first_name`, `middle_name`, `last_name`, `date_of_birth`, `gender`, `phone`, `email`, `address`,`branch_id`,`assign_status`, `status`, `row_created_on`)VALUES('1', '$user_category_x', '$first_name_x', '$middle_name_x', '$last_name_x', '$date_of_birth_x', '$gender_x', '$phone_x', '$email_x', '$address_x','$branch_id_x','$user_type',  '1','$co')";
$query=mysqli_query($conn,$sql);

$user_id=mysqli_insert_id($conn);

if($user_type==1){
mysqli_query($conn,"INSERT INTO user_login(branch_id,module_id, user_category_id, user_id, username, password, status, row_created_on) VALUES ('$branch_id_x','1','$user_category_x','$user_id','$final_username','$password','1','$co')");
}
